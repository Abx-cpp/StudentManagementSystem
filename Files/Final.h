...
public:
        ...
        array<String^>^ rolls)
    {
        ...
        for (int i = 0; i < scores->Length; ++i)
        {
            ...
            {
                MessageBox::Show("Invalid Final mark for " + names[i] + " (" + rolls[i] + ")", "Validation", MessageBoxButtons::OK, MessageBoxIcon::Warning);
                conn->Close();
                return;
            }
        ...
        conn->Close();
        MessageBox::Show("Final marks saved.", "Success", MessageBoxButtons::OK, MessageBoxIcon::Information);
    }
};
